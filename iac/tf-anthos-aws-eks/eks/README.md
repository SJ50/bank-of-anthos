...
| <a name="provider_aws.public-ecr"></a> [aws.public-ecr](#provider\_aws.public-ecr) | >= 4.47 |
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws_load_balancer_controller"></a> [aws\_load\_balancer\_controller](#module\_aws\_load\_balancer\_controller) | ./modules/aws_lb_controller | n/a |
| <a name="module_cert_manager"></a> [cert\_manager](#module\_cert\_manager) | ../../../modules/aws/eks/modules/cert_manager | n/a |
...
| <a name="module_karpenter"></a> [karpenter](#module\_karpenter) | ./modules/karpenter_addon | n/a |
...
| [helm_release.ingress-public](https://registry.terraform.io/providers/hashicorp/helm/latest/docs/resources/release) | resource |
| [helm_release.ingress_internal](https://registry.terraform.io/providers/hashicorp/helm/latest/docs/resources/release) | resource |
...
| [kubectl_manifest.cluster_issuer_nginx_le](https://registry.terraform.io/providers/gavinbunney/kubectl/latest/docs/resources/manifest) | resource |
| [kubectl_manifest.cluster_issuer_r53_le](https://registry.terraform.io/providers/gavinbunney/kubectl/latest/docs/resources/manifest) | resource |
| [kubectl_manifest.example_ssl_lt_r53](https://registry.terraform.io/providers/gavinbunney/kubectl/latest/docs/resources/manifest) | resource |
| [kubectl_manifest.inflate](https://registry.terraform.io/providers/gavinbunney/kubectl/latest/docs/resources/manifest) | resource |
...
| [kubectl_manifest.server](https://registry.terraform.io/providers/gavinbunney/kubectl/latest/docs/resources/manifest) | resource |
| [kubectl_manifest.service](https://registry.terraform.io/providers/gavinbunney/kubectl/latest/docs/resources/manifest) | resource |
| [kubernetes_config_map.aws_auth](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/config_map) | resource |
| [kubernetes_config_map_v1_data.aws_auth](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/config_map_v1_data) | resource |
| [time_sleep.this](https://registry.terraform.io/providers/hashicorp/time/latest/docs/resources/sleep) | resource |
| [time_sleep.wait_wireguard](https://registry.terraform.io/providers/hashicorp/time/latest/docs/resources/sleep) | resource |
...
| <a name="input_cert_manager"></a> [cert\_manager](#input\_cert\_manager) | Cert manager configuration | `any` | <pre>{<br>  "chart": "cert-manager",<br>  "chart_version": "v1.12.3",<br>  "create_irsa": true,<br>  "create_namespace": true,<br>  "create_release": true,<br>  "description": "A Helm chart to deploy cert-manager",<br>  "is_zone_private": false,<br>  "name": "cert-manager",<br>  "namespace": "cert-manager",<br>  "postrender": [],<br>  "repository": "https://charts.jetstack.io",<br>  "role_description": "IRSA for cert-manger project",<br>  "role_name": "cert-manager",<br>  "role_name_use_prefix": true,<br>  "role_permissions_boundary_arn": null,<br>  "role_policies": {},<br>  "route53_hosted_zone_arns": [<br>    "arn:aws:route53:::hostedzone/*"<br>  ],<br>  "values": []<br>}</pre> | no |
...
| <a name="input_custom_addons"></a> [custom\_addons](#input\_custom\_addons) | Custom addons for EKS | `any` | <pre>{<br>  "argocd": false,<br>  "aws_lb_controller": false,<br>  "cert_le_nginx": false,<br>  "cert_le_r53": false,<br>  "cert_manager": false,<br>  "cilium": true,<br>  "example": false,<br>  "inflate": false,<br>  "karpenter": true<br>}</pre> | no |
...
| <a name="input_ingress_external"></a> [ingress\_external](#input\_ingress\_external) | External/Public Ingress nginx configuration | `any` | <pre>{<br>  "create_namespace": false,<br>  "namespace": "ingress-nginx",<br>  "source_cidrs": []<br>}</pre> | no |
| <a name="input_ingress_internal"></a> [ingress\_internal](#input\_ingress\_internal) | Internal Ingress nginx configuration | `any` | <pre>{<br>  "create_namespace": false,<br>  "namespace": "ingress-nginx"<br>}</pre> | no |
| <a name="input_karpenter"></a> [karpenter](#input\_karpenter) | Karpenter configuration | `any` | <pre>{<br>  "architecture": [<br>    "amd64"<br>  ],<br>  "capacity_type": [<br>    "on-demand"<br>  ],<br>  "consolidation": false,<br>  "instance_type": [<br>    "t3.medium"<br>  ]<br>}</pre> | no |
...
| <a name="input_redundancy"></a> [redundancy](#input\_redundancy) | Redundancy across AZs | `number` | `2` | no |
...
| <a name="output_karpenter"></a> [karpenter](#output\_karpenter) | ############################################################################### Karpenter ############################################################################### |
