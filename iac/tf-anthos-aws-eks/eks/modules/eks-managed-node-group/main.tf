...
resource "aws_iam_role_policy_attachment" "this" {
  for_each = { for k, v in toset(compact([
    ...
    "${local.iam_role_policy_prefix}/AmazonEC2ContainerRegistryFullAccess",
    "${local.iam_role_policy_prefix}/AmazonEC2ContainerRegistryReadOnly", #fails without it even having FullAccess above.
    "${local.iam_role_policy_prefix}/service-role/AmazonEBSCSIDriverPolicy",
    "${local.iam_role_policy_prefix}/service-role/AmazonEFSCSIDriverPolicy",
